    ...
    <section className="section contact" id="contact">
      <div className="container contact__grid">
        ...
        <form className="contact-form" onSubmit={submit}>
          ...
          <label>Service needed<select required name="service" value={form.service} onChange={change}><option value="" disabled>Select a service</option><option>Water Damage</option><option>Fire & Smoke Damage</option><option>Mold Remediation</option><option>Storm Damage</option><option>Emergency Restoration</option><option>Dry Ice Blasting</option><option>Other</option></select></label>
