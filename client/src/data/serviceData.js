...
export const serviceData = [
  ...
  {
    slug: 'mold-remediation', Icon: Wind, title: 'Mold remediation', navTitle: 'Mold remediation',
    short: 'Careful mold removal and moisture control for a safer indoor environment.',
    eyebrow: 'Mold remediation', heading: 'Address the moisture. Remove the mold.',
    intro: 'Professional containment, removal, and moisture correction throughout Florida.',
    lead: 'Successful mold remediation means addressing both the affected material and the moisture condition behind it. We establish containment, remove impacted materials, and leave the work area clean and ready for the next step.',
    details: ['Source and moisture assessment', 'Work-area containment', 'Affected-material removal', 'Detailed cleaning and drying'],
    steps: ['Inspect visible and suspected areas', 'Establish containment controls', 'Remove and clean affected materials', 'Verify moisture conditions are controlled'], image: '/images/bathroom-before.png',
  },
  {
  ...
  },
  {
    ...
    intro: 'Rapid coordination for urgent water, fire, mold, and storm damage throughout Florida.',
