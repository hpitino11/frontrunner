...
const projects = [
  ...
  { number: '02', Icon: Snowflake, service: 'Dry ice blasting', title: 'Garage dry ice cleaning', copy: 'Specialized dry ice blasting removes stubborn surface contamination with minimal secondary waste and no added water.', before: '/images/garage-before.png', after: '/images/garage-after.png', beforeAlt: 'Garage before dry ice blasting', afterAlt: 'Garage after dry ice blasting' },
];

export default function BeforeAfterPage() {
  return (
    <>
      <PageHero eyebrow="Before & after" title={<>Proof you can <span>see clearly.</span></>} copy="Real visual examples of the recovery process across water mitigation and dry ice blasting projects." image="/images/living-after.png" imageAlt="Restored living room after water mitigation" />
